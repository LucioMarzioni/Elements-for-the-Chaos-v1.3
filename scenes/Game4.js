...
export default class Game4 extends Phaser.Scene {
    ...
    preload() {
      ...
      this.load.image("upe", "./public/upnj.png");
      this.load.image("upv", "./public/upnv.png");
      ...
      this.load.image("shield", "./public/saltobajo.png")
      this.load.image("vel", "./public/velocidadlenta.png")
  ...
  update() {
    ...
    if (this.cursor.up.isDown && this.player.body.touching.down && !this.activateshield) {
    ...
    pj(_player, recolectables) {
      ...
      if (recolectables.texture.key === "upe") {
        ...
        this.shield = this.add.image(740, 25, "shield").setScale(0.5);
    ...
    pj2(_player, recolectables2) {
        if (recolectables2.texture.key === "upv") {
