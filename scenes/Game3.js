   ...
   this.anims.create({
    ...
    this.player.anims.play('turn');
      ...
      this.toxictime = setTimeout(() => {
        this.warning = this.add.image(50, 70, "warning").setScale(0.15);
        this.time.delayedCall(3000, () => {
        this.toxicd = this.physics.add.sprite(50, 50, "toxicd").setScale(0.3);
  ...
  update() {
    ...
    handlerTimer() {
      ...
      if (this.timer <= 0) {
       ...
       this.scene.start("Gameover3", { score: this.score });  
      }
    }
  }
